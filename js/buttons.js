...
function toggleTopographic() {
    ...
    if (topographicVisible) {
        ...
        miElemento.innerHTML = '<iframe class="nav-info-iframe" src="/info/topografich_info.html" frameborder="0"> </iframe>';
...
function toggleGeological() {
    if (!GeologicalVisible) {
        ...
        // Obtén el elemento por su ID
        var miElemento = document.getElementById("Information");
        miElemento.innerHTML = '<iframe class="nav-info-iframe" src="/info/Geologic_SCALE.html" frameborder="0"> </iframe>';
        // Agrego contenido al recuadro de info
        // Obtén el elemento por su ID
        var miElemento = document.querySelector(".scene-nav-infoo");
        // Cambia el estilo del elemento
...
function toggleTemperatureMAX() {
    if (!temperatureVisibleMAX) {
        ...
        // Obtén el elemento por su ID
        var miElemento = document.getElementById("Information");
        miElemento.innerHTML = '<iframe class="nav-info-iframe" src="/info/temperature_max_info.html" width="500"heg frameborder="0">';
        // Agrego contenido al recuadro de info
        // Obtén el elemento por su ID
        var miElemento = document.querySelector(".scene-nav-infoo");
        // Cambia el estilo del elemento
...
function toggleTemperatureMIN() {
    if (!temperatureVisibleMIN) {
        ...
        // Obtén el elemento por su ID
        var miElemento = document.getElementById("Information");
        miElemento.innerHTML = '<iframe class="nav-info-iframe" src="/info/temperature_min_info.html" width="500" frameborder="0">';
        // Agrego contenido al recuadro de info
        // Obtén el elemento por su ID
        var miElemento = document.querySelector(".scene-nav-infoo");
        // Cambia el estilo del elemento
    ...
    if (otherMissionsVisible) {
        ...
        otherMissions.forEach(function(mission) {
            ...
            mission.addEventListener('click', function() {
                var miElemento = document.getElementById("Information");
                miElemento.innerHTML = '<iframe class="nav-info-iframe" src="InformacionOM.html?Titulo='+missionData.name+'-'+missionData.agency+'&Texto='+missionData.info+'&image='+missionData.image+'" frameborder="0" width="400" height="550"> </iframe>';
                var miElemento = document.querySelector(".scene-nav-infoo");
                miElemento.style.display = "block";
            });
        });
