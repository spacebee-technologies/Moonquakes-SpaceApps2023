...
with open(f'data/{catalog}.csv', newline='') as file_handler:
    ...
    for row in spamreader:
        if n != 0:
            info = ''
            description = "A moonquake is a seismic event that occurs on the Moon, similar to an earthquake on Earth. These quakes are caused by factors like gravitational forces from Earth, cooling and contraction of the Moon's interior, and impacts from space debris. Moonquakes come in two types: deep moonquakes, caused by Earth's gravitational pull, and shallow moonquakes, linked to temperature changes. While moonquakes are generally less intense than earthquakes, they provide valuable insights into lunar geology and seismic activity, important for future lunar missions and habitats"
            if row[0] == 'M':
                info = 'Natural impact'
